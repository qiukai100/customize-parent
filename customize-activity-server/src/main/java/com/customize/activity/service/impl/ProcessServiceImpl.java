...
public class ProcessServiceImpl implements ProcessService {
    ...
    @Autowired
    public ProcessServiceImpl(RuntimeService runtimeService, TaskService taskService, HistoryService historyService, RepositoryService repositoryService, SpringProcessEngineConfiguration processEngineConfiguration) {
    ...
    public void getFlowImgByInstanceId(String processInstanceId, OutputStream outputStream) {
        try {
            ...
            historicActivityInstances.forEach(instance -> highLightedActivityIds.add(instance.getActivityId()));
...
//				processDiagramGenerator = new CustomProcessDiagramGenerator();
            ...
            InputStream imageStream = processDiagramGenerator.generateDiagram(bpmnModel, "png", highLightedActivityIds,
    ...
    private static List<String> getHighLightedFlows(BpmnModel bpmnModel, List<HistoricActivityInstance> historicActivityInstances) {
        ...
        FlowNode currentFlowNode, targetFlowNode;
            ...
            if ("parallelGateway".equals(currentActivityInstance.getActivityType()) || "inclusiveGateway".equals(currentActivityInstance.getActivityType())) {
                ...
                for (SequenceFlow sequenceFlow : sequenceFlows) {
                    for (int i = 0; i < historicActivityInstances.size() - 1; i++) {
                        ...
                        HistoricActivityInstance historicActivityInstance2 = historicActivityInstances.get(i + 1);
                        if (historicActivityInstance.getActivityId().equals(sequenceFlow.getSourceRef()) && historicActivityInstance2.getActivityId().equals(sequenceFlow.getTargetRef())) {
