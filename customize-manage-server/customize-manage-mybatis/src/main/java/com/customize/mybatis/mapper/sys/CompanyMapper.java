...
public interface CompanyMapper extends BaseMapper<Company> {
     ...
     * 根据ID查询公司
     */
    CompanyDto findById(@Param("pkCompanyId") String pkCompanyId, @Param("isDelete") Integer isDelete);
     ...
     * 批量移除公司（逻辑删除）
     */
    int removeCompanyBatch(@Param("pkCompanyIds") List<String> pkCompanyIds, @Param("isDelete") Integer isDelete);

    /**
     * 批量删除公司（物理删除）
     */
    int deleteCompanyBatch(@Param("pkCompanyIds") List<String> pkCompanyIds);
}
